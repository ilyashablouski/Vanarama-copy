...
import { CheckoutPageContainerProps, IAdditionalOptionsFormValues } from "./interfaces";
...
const CheckoutPageContainer: React.FC<CheckoutPageContainerProps> = ({
  ...
  // order.leaseType
  // const vehicleType = useMemo(() => {}, [vehicleProduct]);
        ...
        <div>
          ...
          <div className="side-bar-layout">
            <div>
              ...
              <AdditionalOptionsForm methods={methods} />
            </div>
