...
import { GetVatDetailsQueryVariables, GetVatDetailsQuery } from '../../../generated/GetVatDetailsQuery';
...
export const VatDetailsFormContainer: React.FC<IVatDetailsFormContainerProps> = ({
  ...
  const { data, loading, error } = useQuery<GetVatDetailsQuery, GetVatDetailsQueryVariables>(
    GET_VAT_DETAILS,
    {
      variables: {
        companyUuid
  ...
  return <VatDetailsForm onSubmit={handleSubmit} vatDetails={data?.companyByUuid} />;
};
