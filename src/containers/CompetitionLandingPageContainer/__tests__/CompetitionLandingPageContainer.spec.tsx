...
import CompetitionLandingPageContainer from '../CompetitionLandingPageContainer';
...
describe('<CompetitionLandingPageContainer />', () => {
  beforeAll(async () => {
    await preloadAll();
  });
  it('should match snapshot', async () => {
    ...
    const getComponent = render(
      <MockedProvider addTypename={false}>
        <CompetitionLandingPageContainer data={DATA} />
      </MockedProvider>,
    );
    // ASSERT
    await waitFor(() => {
