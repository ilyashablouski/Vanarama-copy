...
interface IBusinessSummaryFormDirectorDetailsItemProps {
  director: CompanyAssociate;
  onEdit: () => any;
}

const BusinessSummaryFormDirectorDetailsItem: FCWithFragments<IBusinessSummaryFormDirectorDetailsItemProps> = ({
  onEdit,
  director,
}) => {
...
BusinessSummaryFormDirectorDetailsItem.fragments = {
  director: DirectorDetailsForm.fragments.associates,
};

export default BusinessSummaryFormDirectorDetailsItem;
