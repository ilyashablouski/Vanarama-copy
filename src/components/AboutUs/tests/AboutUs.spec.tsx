...
import { useAboutUsPageData, GET_ABOUT_US_PAGE_DATA } from '../gql';
import { MockedResponse, MockedProvider } from '@apollo/client/testing';
import { GetAboutUsPageData, GetAboutUsPageData_aboutUsLandingPage } from '../../../../generated/GetAboutUsPageData';
    ...
    it('renders correctly with data', async () => {
        (useAboutUsPageData as jest.Mock).mockReturnValue({
            ...
            data: {
                ...
                } as GetAboutUsPageData_aboutUsLandingPage
            },
            error: undefined,
        });

        const getComponent = () => {
            return renderer.create(<AboutUs />).toJSON();
        };
