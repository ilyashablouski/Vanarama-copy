...
const Hero: React.FC<IHeroProps> = ({
  ...
  const renderHeroRight = () => {
    if (showImageonRight) {
      return (
        <div className="image -expand -plain hero--image">
          <img className="image--native" src="https://ellisdonovan.s3.eu-west-2.amazonaws.com/benson-hero-images/Audi-Hero-Image-removebg-preview.png" />
        </div>
      )
    }
    ...
    <div className="row:bg-hero">
      <div className="row:hero">
        ...
        <div className="hero--right" style={{ minHeight: '347px' }}>
          ...
          {!showImageonRight && <BenefitsBar countItems={4} />}
        </div>
