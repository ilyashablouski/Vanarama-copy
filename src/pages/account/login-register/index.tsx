...
import { registerSuccessMessage, registerErrorMessage } from 'services/redux/account/selectors';
...
export const IndexPage: React.FC<Props> = ({ login, register, successMessage, errorMessage, authenticated, token }) => {
  return (
    <>
      <div className="heading" style={{ paddingTop: '16px', paddingBottom: '16px' }}><Heading size="xlarge">Login / Register</Heading></div>
...
const mapStateToProps = ({ register: { success, error } ,  auth: { authenticated, data } }: RootState) => {
  return {
    authenticated,
