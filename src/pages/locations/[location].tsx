...
export const LocationsPage: NextPage = () => {
  ...
  const { data } = useQuery<LocationsPageData>(LOCATIONS_PAGE_CONTENT);
        ...
        <div className="row:hero">
          <div className="hero--left">
            ...
            <Text size="large" color="inherit" tag="p">
              Cillum culpa nulla nisi fugiat Lorem ipsum.
            </Text>
            <Image
      ...
      <div className="row:featured-left">
        <div>
          <Heading color="black" size="lead" tag="h3">
            Hello, my name is Caroline Richmond. Malcolm and I would like to
            welcome you to Vanarama Bath and Salisbury.
          </Heading>
          <hr className="-fullwidth\" />
          <ReactMarkdown
            escapeHtml={false}
            source={
              data?.regionalOfficesPage.body ||
              `Labore deserunt qui voluptate id proident aliquip duis ad proident Lorem est Lorem occaecat dolore amet dolore culpa esse in cupidatat commodo mollit enim sit ad elit ex nulla aliquip amet anim veniam ipsum veniam cillum voluptate consectetur laborum qui
            Fugiat sunt sit qui tempor excepteur magna id in deserunt qui ea magna laborum laborum ipsum quis officia ut qui velit anim occaecat quis amet proident est proident laboris dolore amet quis amet nulla non incididunt exercitation nulla consequat tempor
            Sunt ullamco sit elit nostrud exercitation exercitation nisi excepteur occaecat nisi eiusmod adipisicing magna aliquip proident esse tempor sit incididunt minim dolor fugiat ipsum veniam ullamco pariatur aliquip ut aliqua`
            }
            renderers={{
              link: props => {
                const { href, children } = props;
